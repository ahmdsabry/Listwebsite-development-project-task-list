...
<body>
 ...
 <nav class="navbar navbar-expand-lg bg-body-tertiary"  >
  ...
  <form action="NewServlet" method="get">
        <input type="hidden" name="log" value="Home">
        <input type="hidden" name="userid" value="${add}">
        <input type="submit" class="nav-link" style="color: white; background: none; border: none; cursor: pointer;" value="Home">
    </form>          <a class="nav-link" style="color: white;text-decoration: underline" href="ViewSummerize.jsp">View Summerize</a>
        <a class="nav-link" style="color: white" href="Search.jsp">Search</a>
...
<div class="container">
    <h2 class="my-4">Summerize Page</h2>
    ...
    <form action="NewServlet" id="taskForm"  class="mb-4">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input class="form-control" id="task" name="summerize" placeholder="Enter the percentage of Summerize" >
            </div>
        </div>
...
<input class="btn btn-btn btn-outline-warning" type="submit" name="log"  value="Summerize">
              </div>
        </div>
